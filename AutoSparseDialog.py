...
# Form implementation generated from reading ui file 'AutoSparseDialog.ui'
#
...
class Ui_AutoSparseDialog(object):
    def setupUi(self, AutoSparseDialog):
        AutoSparseDialog.setObjectName("AutoSparseDialog")
        AutoSparseDialog.resize(380, 509)
        self.verticalLayout = QtWidgets.QVBoxLayout(AutoSparseDialog)
        self.verticalLayout.setObjectName("verticalLayout")
        self.frame = QtWidgets.QFrame(AutoSparseDialog)
        ...
        self.frame_2 = QtWidgets.QFrame(AutoSparseDialog)
        ...
        self.frame_3 = QtWidgets.QFrame(AutoSparseDialog)
        ...
        self.widget_3 = QtWidgets.QWidget(AutoSparseDialog)
        ...
        self.retranslateUi(AutoSparseDialog)
        QtCore.QMetaObject.connectSlotsByName(AutoSparseDialog)

    def retranslateUi(self, AutoSparseDialog):
        _translate = QtCore.QCoreApplication.translate
        AutoSparseDialog.setWindowTitle(_translate("AutoSparseDialog", "Dialog"))
        self.label.setText(_translate("AutoSparseDialog", "路径设置"))
        self.label_2.setText(_translate("AutoSparseDialog", "输入："))
        self.input_path_btn.setText(_translate("AutoSparseDialog", "..."))
        self.input_path_label.setText(_translate("AutoSparseDialog", "图片路径"))
        self.ouput_path_label.setText(_translate("AutoSparseDialog", "结果文件夹"))
        self.label_5.setText(_translate("AutoSparseDialog", "输出："))
        self.output_path_btn.setText(_translate("AutoSparseDialog", "..."))
        self.label_12.setText(_translate("AutoSparseDialog", "工作路径："))
        self.base_path_label.setText(_translate("AutoSparseDialog", "database路径"))
        self.base_path_btn.setText(_translate("AutoSparseDialog", "..."))
        self.label_6.setText(_translate("AutoSparseDialog", "集群参数设置"))
        self.label_7.setText(_translate("AutoSparseDialog", "每个节点图像上限数："))
        self.label_9.setText(_translate("AutoSparseDialog", "质量参数设置"))
        self.label_10.setText(_translate("AutoSparseDialog", "选择质量："))
        self.quality_input.setItemText(0, _translate("AutoSparseDialog", "Self Defined"))
        self.quality_input.setItemText(1, _translate("AutoSparseDialog", "Lowest"))
        self.quality_input.setItemText(2, _translate("AutoSparseDialog", "low"))
        self.quality_input.setItemText(3, _translate("AutoSparseDialog", "Medium"))
        self.quality_input.setItemText(4, _translate("AutoSparseDialog", "High"))
        self.autoDenseStartBtn.setText(_translate("AutoSparseDialog", "开始重建"))
